python3 RecordFromTopic.py --image_topic /xtion/rgb/image --camera_info_topic /xtion/rgb/camera_info --gripper_pose_csv gripper_pose.csv --image_rate 1 --timeout 2.04
